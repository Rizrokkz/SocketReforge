...
public final class TreasureChestSocketLootListener {
    ...
    private static RollResult applyLootSocketsToContainer(Player player, ContainerBlockWindow window, boolean loot4EveryoneChest) {
     ...
     */
    private static boolean shouldSkipPrefilledDroplist(Player player, ContainerBlockWindow window, ItemContainer container, boolean loot4EveryoneChest) {
    ...
    private static boolean isWorldLootContainer(Player player, ContainerBlockWindow window, String source, boolean loot4EveryoneChest) {
